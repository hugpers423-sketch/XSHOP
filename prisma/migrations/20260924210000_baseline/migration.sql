...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('YAPE', 'PLIN', 'CASH_ON_DELIVERY', 'BANK_TRANSFER', 'CARD');
...
-- CreateIndex
CREATE INDEX "LiveStream_sellerId_isLive_idx" ON "LiveStream"("sellerId", "isLive");
...
-- AddForeignKey
ALTER TABLE "LiveStream" ADD CONSTRAINT "LiveStream_sellerId_fkey" FOREIGN KEY ("sellerId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
